...
export default function About() {
  ...
  return (
    <section id='section-about' className='bg-gradient-to-b from-violet-700 to-violet-800 w-full pt-40 pb-40 min-h-[calc(100vh-48px)] flex flex-col justify-center items-center gap-4 xl:flex-row'>
      <Image src='https://avatars.githubusercontent.com/u/40845046?s=400&u=53469f66cc29d7eb4921603120b92639f09415f0&v=4' className='animate-border-gradient border-gradient mb-20 xl:mb-0' alt='user-image' width={300} height={300} />
      <div className='flex flex-col p-4 max-w-[600px]'>
        ...
        <div className='grid grid-cols-[repeat(auto-fit,50px)] gap-7 justify-items-center items-center justify-between xl:justify-center pt-8'>

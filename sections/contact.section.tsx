...
export default function Contact() {
  ...
  return <section id="section-contact" className="w-full bg-gradient-to-b from-violet-800 to-violet-900 flex flex-col items-center justify-center pb-32 px-6">
